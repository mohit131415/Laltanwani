...
const Video = () => {
  ...
  return (
    <motion.section
      ref={videoRef}
      className="relative max-h-screen overflow-hidden bg-gradient-to-br from-background to-secondary/20"
      style={{ opacity, scale }}
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold font-display bg-gradient-to-r from-primary via-primary/80 to-primary bg-clip-text text-transparent">
