...
const Stats = () => {
  ...
  return (
    <section ref={ref} className="py-20 !bg-white bg-gradient-to-br from-primary/5 to-primary/10">
      <div className="container mx-auto px-4">
        <motion.h2
          className="text-4xl md:text-5xl font-bold mb-16 text-center font-display bg-gradient-to-r from-primary via-primary/80 to-primary bg-clip-text text-transparent"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-primary/0 rounded-xl blur-xl transition-all duration-500 group-hover:bg-primary/30" />
              <div className="relative p-8 rounded-xl bg-white border border-border">
